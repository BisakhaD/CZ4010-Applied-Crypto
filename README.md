...
This project is fully functional, to the extent tested by us. If you are able to find ways for us to improve, please do not hesitate to drop us an email at ```[Bisakha Das](mailto:bisakha001@e.ntu.edu.sg?subject=[GitHub]%20CZ4010%20Applied%20Crypto)``` or ```ahkshara001@e.ntu.edu.sg```, so that we can learn from our mistakes :)
